                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route($rolePrefix . 'ruangan.index') }}">Ruangan</a></li>
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    @can('update', $ruangan)
                        ...
                        @endif
                    @endcan
                    <a href="{{ route($rolePrefix . 'ruangan.index') }}" class="btn btn-secondary btn-sm">
                                    ...
                                    <tbody>
                                        @foreach ($barangGrouped as $namaBarang => $items)
                                            ...
                                            <tr>
                                                <td>
                                                    <a
                                                        href="{{ route($rolePrefix . 'barang.show', $firstItem->barang->id) }}">
                                                        {{ $namaBarang }}
                                                    </a>
                                                </td>
                                                <td>
                                    ...
                                    <tbody>
                                        @foreach ($unitBarang as $index => $unit)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route($rolePrefix . 'barang.show', $unit->barang->id) }}">
