...
@section('content')
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route($rolePrefix . 'kategori-barang.index') }}">Kategori
                                    Barang</a></li>
        ...
        <div class="row mb-3">
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    ...
                    @endcan
                    <a href="{{ $rolePrefix . 'kategori-barang.index') }}" class="btn btn-secondary btn-sm">
                                        ...
                                        @foreach ($kategoriBarang->barangs as $index => $barang)
                                            <tr>
                                                ...
                                                <td>
                                                    @can('view', $barang)
                                                        <a
                                                            href="{{ $rolePrefix . 'barang.show', $barang->id) }}">{{ $barang->nama_barang }}</a>
                                                    @else
                                                        {{ $barang->nama_barang }}
                                                    @endcan
                                                </td>
    ...
    @can('update', $kategoriBarang)
        @include('pages.kategori.partials.modal-edit') {{-- Pastikan path partial ini benar --}}
    @endcan
@endsection
            ...
            if (modalEditKategoriElement) {
                ...
                document.querySelectorAll('.btn-edit-kategori-trigger').forEach(button => {
                    button.addEventListener('click', () => {
                        ...
                        if (form) {
                            form.action =
                                `{{ $rolePrefix . 'kategori-barang.update', ['kategori_barang' => ':id']) }}`
                                .replace(':id', data.id);
