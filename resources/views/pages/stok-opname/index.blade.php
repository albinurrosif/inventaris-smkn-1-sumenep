        ...
        <div class="card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                @can('create', App\Models\StokOpname::class)
                    <a href="{{ route($rolePrefix . 'stok-opname.create') }}" class="btn btn-primary btn-md"
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route($rolePrefix . 'stok-opname.index') }}" class="mb-4">
                    <div class="row g-2 align-items-end">
                        ...
                        @if (
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                <a href="{{ route($rolePrefix . 'stok-opname.index') }}"
                                ...
                                <tr class="{{ $so->trashed() ? 'table-danger-light' : '' }}">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-1 justify-content-center">
                                            @if ($so->trashed())
                                                @can('restore', $so)
                                                    <form action="{{ route($rolePrefix . 'stok-opname.restore', $so->id) }}"
                ...
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            if (formDelete) {
                                formDelete.action =
                                    `{{ route($rolePrefix . 'stok-opname.destroy', ['stokOpname' => ':id']) }}`
                                    .replace(':id', soId);
                                formDelete.submit();
                            }
                        }
