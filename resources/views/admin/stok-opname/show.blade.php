    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.stok-opname.index') }}">Stok
                                    Opname</a>
                            </li>
        ...
        <div class="card">
                            ...
                            @forelse ($stokOpname->detailStokOpname as $index => $detail)
                                <tr id="row-detail-{{ $detail->id }}" data-detail-id="{{ $detail->id }}">
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="badge bg-light text-dark border">{{ $detail->kondisi_tercatat }}</span>
                                    </td>
                                    <td>
                                        @if ($stokOpname->status === StokOpname::STATUS_DRAFT && !$stokOpname->trashed())
            ...
            <div class="card-footer text-end">
                <a href="{{ route('admin.stok-opname.index') }}" class="btn btn-outline-secondary">Kembali ke Daftar SO</a>
                @if ($stokOpname->status === StokOpname::STATUS_DRAFT && !$stokOpname->trashed())
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                btnFinalize.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.action =
                                `{{ route('admin.stok-opname.finalize', ['stokOpname' => ':id']) }}`
                                .replace(':id', soId);
                            form.submit();
                        }
                    });
                ...
                btnCancel.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.action =
                                `{{ route('admin.stok-opname.cancel', ['stokOpname' => ':id']) }}`
                                .replace(':id', soId);
                            form.submit();
                        }
                    });
            ...
            $('.select2-barang-qr-ajax').select2({
                ...
                ajax: {
                    url: "{{ route('admin.stok-opname.search-barang-qr') }}", // Anda perlu membuat route ini
                    dataType: 'json',
                    delay: 250,
            ...
            $('#formTambahBarangTemuan').on('submit', function(e) {
                ...
                fetch("{{ route('admin.stok-opname.add-barang-temuan') }}", { // Anda perlu membuat route ini
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': csrfToken,
                            'Accept': 'application/json',
