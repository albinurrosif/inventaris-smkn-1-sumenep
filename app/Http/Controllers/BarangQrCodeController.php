...
class BarangQrCodeController extends Controller
{
     ...
     */
    public function redirectFromScan(Request $request, BarangQrCode $barangQrCode): RedirectResponse
    {
        // Karena rute ini sudah dilindungi middleware 'auth', kita bisa langsung asumsikan user sudah login.
        $user = Auth::user();
        /** @var \App\Models\User $user */
        ...
        Log::warning("Rute '{$routeName}' tidak ditemukan untuk peran '{$user->role}'. Mengalihkan ke dashboard.");
